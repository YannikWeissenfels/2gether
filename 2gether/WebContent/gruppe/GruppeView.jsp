...
<body class="w3-theme-l5">
	<form action="GruppeAppl.jsp" method="get">
		<!--Beans -->
					...
					<div>
						<div class="fixierterButton">
							<input type='submit' class="w3-button  w3-theme-l4"
								name='erstellen' value='neue Gruppe erstellen' /><br> <br>
							<br>
						</div>
					</div>
					<br> <br>
							...
							<div class="w3-card w3-round w3-white">
								<div class="w3-container w3-padding w3-left-align">
									<div>
										...
										<jsp:getProperty property="eigeneGruppenView" name="gb" />
						...
						<div class="w3-card w3-round w3-white">
							<div class="w3-container w3-padding">
								...
								<div class="scrollmenu scrollcard">
									<jsp:getProperty property="alleGruppenView" name="gb" />
