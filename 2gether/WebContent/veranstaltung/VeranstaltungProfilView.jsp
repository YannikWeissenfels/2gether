...
<body class="w3-theme-l5">
	<form action="VeranstaltungAppl.jsp">
		<!--Beans -->
    ...
    <img src="/w3images/avatar2.png" class="w3-circle" style="height:23px;width:23px" alt="Avatar">
		...
		<div class="w3-container w3-content"
			...
			<div class="w3-row">
				<!-- Left Column -->
				<div class="w3-col m2">
					<jsp:getProperty name="vb" property="gruppe3" />
					<!-- Profile -->
					<div></div>
					<br> <br>
					<!-- End Left Column -->
							...
							<div class="w3-card w3-round w3-white">
								<div class="w3-container w3-padding w3-left-align">
									<div>
										...
										<jsp:getProperty property="veranstaltungProfilView" name="vb" />
									</div>
						...
						<div class="w3-card w3-round w3-white">
							<div class="w3-container w3-padding">
								...
								<div class="scrollmenu scrollcard">
									<jsp:getProperty name="vb" property="eigeneVeranstaltungenViewRechts" />
									<br>
								</div>
