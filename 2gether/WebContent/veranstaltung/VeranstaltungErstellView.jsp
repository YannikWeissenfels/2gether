...
<title>Veranstaltung speichern</title>
...
<body class="w3-theme-l5">
	<form action="VeranstaltungAppl.jsp" method="get" onsubmit="return ueberpruefeVeranstaltung(this)">
		<!--Beans -->
    ...
    <img src="/w3images/avatar2.png" class="w3-circle" style="height:23px;width:23px" alt="Avatar">
		...
		<div class="w3-container w3-content"
			...
			<div class="w3-row">
				<!-- Left Column -->
				<div class="w3-col m2">
					<jsp:getProperty property="buttonsErstellen" name="vb" />
							...
							<div class="w3-card w3-round w3-white">
								<div class="w3-container w3-padding w3-left-align">
									<div>
										...
										<!-- Content -->
										<b><jsp:getProperty name="bb" property="infoNachricht" /></b><br />
										<jsp:getProperty name="vb" property="veranstaltungErstellView" />
									</div>
