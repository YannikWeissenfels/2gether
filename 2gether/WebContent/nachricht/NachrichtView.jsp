...
<body class="w3-theme-l5">
	<form action="NachrichtAppl.jsp" method="get">
		<!--Beans -->
				...
				<div class="w3-col m3">
					...
					<div>
						<input type='submit' class="w3-button w3-theme-l4"
							name="neuenachricht" value="Neue Nachricht"><br /> <br />
							</div>
						...
						<div class="w3-row">
							<div class="w3-card w3-round w3-white">
								<div class="w3-container w3-padding w3-center w3-left-align">
									...
									<div class="scrollmenu_2 scrollcard_3 ">
										<jsp:getProperty name="nb"
											property="HTMLAlleBenutzerMitDenenIchSchreibe" />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="w3-card w3-round w3-white">
								<div class="w3-container w3-padding w3-left-align ">
									<div>
										...
										<!-- Auflistung der Chats.. Umsetzung der Chatgestaltung noch unklar.. "Nachrichten" werden in der Konsole ausgegeben.. -->


										<b><jsp:getProperty name="bb" property="infoNachricht" />
											<jsp:getProperty name="bb" property="aktionNachricht" /></b>



										<div class="scrollmenu scrollcard_2">
											<jsp:getProperty name="nb"
												property="HTMLNachrichtenAnBenutzer" />
										</div>
