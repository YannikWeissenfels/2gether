		...
		<div class="w3-row">
			...
			<div class="w3-col m4">
				...
				<div class="w3-card w3-round w3-white">
					<div class="w3-container w3-padding w3-center w3-left-align">
					
						<div>
							<h5>Vorgeschlagene Benutzer</h5>
						</div>
						<div class="scrollmenu scrollcard">
							<jsp:getProperty name="sb"
								property="HTMLAllerVorgeschlagenenPersonen" />
							<div>
							</div>
						...
						<div class="w3-card w3-round w3-white">
							<div class="w3-container w3-padding w3-left-align">
								<div>
									...
									<!-- Content -->
									<form action="StartAppl.jsp" method="get">
										<h5><jsp:getProperty name="bb"
															property="infoNachricht" /></h5>

											
												<jsp:getProperty name="profb"
														property="HTMLAllerFreundschaftsanfragen" /><br /> 
												
											
											<jsp:getProperty
														name="nb" property="infoNeueNachrichten" /><br />
												
										

<!-- Trennstrich zwischen Nachrichten und vorgeschlagenenen Veranstaltungen -->
										<hr>

										<h5>Vorgeschlagene Veranstaltungen</h5><br /> <br />

										<div class="scrollmenu scrollcard_2">
											<jsp:getProperty name="sb"
												property="HTMLAllerVorgeschlagenenVeranstaltungen" />
										</div>
			...
			<div class="w3-col m4 ">
				...
				<div class="w3-card w3-round w3-white w3-center">
					<div class="w3-container w3-padding w3-center">
						<div>
							<h5>Vorgeschlagene Gruppen</h5>
						</div>
						<div class="scrollmenu scrollcard">
							<jsp:getProperty name="sb"
								property="HTMLAllerVorgeschlagenenGruppen" />
						</div>
