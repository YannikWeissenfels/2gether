				...
				<div class="w3-col m2">
					...
					<div class="fixierterButton">
						<input type="submit" class="w3-button  w3-theme-l4 >"
							name="bearbeiten" value="Profil bearbeiten">
											...
											<tr>
												<td width="80%">
													<table>
														...
														<tr>
															<td></td>
															<td><br /> <h5>Matching-Einstellungen</h5></td>
														</tr>
														<tr>
															<td></td>
												...
												<td class="regRight" width="20%"><div class="w3-container w3-padding w3-right-align">
														<jsp:getProperty name="profb" property="HTMLBild" />
													</div></td>
										</table>
									</div>
								</div>
